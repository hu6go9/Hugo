...
const FORMATIONS = {
  "4-3-3": {
    label: "4-3-3",
    slots: [
      { code: "GK", pos: "G", top: 92, left: 50 },
      { code: "DL", pos: "DG", top: 72, left: 16 },
      { code: "DCG", pos: "DC", top: 76, left: 38 },
      { code: "DCD", pos: "DC", top: 76, left: 62 },
      { code: "DR", pos: "DD", top: 72, left: 84 },
      { code: "MG", pos: "MG", top: 50, left: 24 },
      { code: "MC", pos: "MC", top: 52, left: 50 },
      { code: "MD", pos: "MD", top: 50, left: 76 },
      { code: "AG", pos: "AG", top: 20, left: 22 },
      { code: "BU", pos: "BU", top: 14, left: 50 },
      { code: "AD", pos: "AD", top: 20, left: 78 },
    ],
  },
  "4-4-2": {
    label: "4-4-2",
    slots: [
      ...
      { code: "DCD", pos: "DC", top: 76, left: 62 },
      { code: "DR", pos: "DD", top: 72, left: 84 },
      { code: "MG", pos: "MG", top: 50, left: 14 },
      { code: "MCG", pos: "MC", top: 52, left: 38 },
      { code: "MCD", pos: "MC", top: 52, left: 62 },
      { code: "MD", pos: "MD", top: 50, left: 86 },
      { code: "BU1", pos: "BU", top: 18, left: 38 },
      { code: "BU2", pos: "BU", top: 18, left: 62 },
    ],
  },
  "4-2-3-1": {
    label: "4-2-3-1",
    slots: [
      ...
      { code: "DCD", pos: "DC", top: 76, left: 62 },
      { code: "DR", pos: "DD", top: 72, left: 84 },
      { code: "MDC1", pos: "MDC", top: 58, left: 38 },
      { code: "MDC2", pos: "MDC", top: 58, left: 62 },
      { code: "MOG", pos: "MOC", top: 32, left: 20 },
      { code: "MOC", pos: "MOC", top: 30, left: 50 },
      { code: "MOD", pos: "MOC", top: 32, left: 80 },
      { code: "BU", pos: "BU", top: 12, left: 50 },
    ],
  },
  "3-5-2": {
    label: "3-5-2",
    slots: [
      ...
      { code: "MG", pos: "MG", top: 50, left: 10 },
      { code: "MDC1", pos: "MDC", top: 56, left: 34 },
      { code: "MC", pos: "MC", top: 50, left: 50 },
      { code: "MDC2", pos: "MDC", top: 56, left: 66 },
      { code: "MD", pos: "MD", top: 50, left: 90 },
      { code: "BU1", pos: "BU", top: 18, left: 38 },
      { code: "BU2", pos: "BU", top: 18, left: 62 },
    ],
  },
